    ...
    <div className="bg-white relative rounded-tl-[8px] rounded-tr-[8px] shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center p-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Noto_Sans_KR:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[#231a16] text-[16px] whitespace-pre-wrap">
            Usage Guide
          </p>
        </div>
      </div>
...
function DocumentDetails() {
  return (
    <div
      className="content-stretch flex flex-col font-['Noto_Sans_KR:Regular',sans-serif] font-normal gap-[8px] items-start leading-[1.5] relative shrink-0 w-[99px] whitespace-pre-wrap"
      data-name="Document Details"
    >
...
function DocumentDetails1() {
  return (
    <div
      className="content-stretch flex flex-col font-['Noto_Sans_KR:Regular',sans-serif] font-normal gap-[8px] items-start relative shrink-0 text-[#231a16] w-[292px] whitespace-pre-wrap"
      data-name="Document Details"
    >
      <p className="leading-[1.5] relative shrink-0 w-full">
        Japanese national
      </p>
...
function DocumentType() {
  return (
    <div
      ...
      data-name="Document Type"
    >
      <ol
        className="block font-['Noto_Sans_KR:Medium',sans-serif] font-medium leading-[0] min-w-full relative shrink-0 text-[#231a16] w-[min-content]"
        start="1"
      >
...
function DocumentDetails2() {
  return (
    <div
      className="content-stretch flex flex-col gap-[16px] items-start leading-[0] relative shrink-0 text-[#231a16] text-[14px]"
      data-name="Document Details"
    >
      <ol
        className="block font-['Noto_Sans_KR:Medium',sans-serif] font-medium min-w-full relative shrink-0 w-[min-content]"
        start="2"
      >
        <li className="ms-[21px] whitespace-pre-wrap">
          <span className="leading-[normal]">
            My Number Confirmation Document
          </span>
        </li>
      </ol>
        ...
        <ul className="list-disc whitespace-pre-wrap">
          ...
          <li className="ms-[21px]">
            <span className="leading-[1.5]">
              Residence certificate with my number
            </span>
          </li>
        </ul>
      </div>
    ...
    >
      ...
      <div className="flex items-center justify-center relative self-stretch shrink-0">
        <div className="-scale-y-100 flex-none h-full rotate-180">
          <div
            className="h-full overflow-clip relative w-[24px]"
...
function Subsection1() {
  return (
    <div
      className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[1322px]"
      data-name="Subsection"
    >
      <p className="font-['Noto_Sans_KR:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#231a16] text-[16px] w-full whitespace-pre-wrap">
        Confirmation of identity at the time of membership
      </p>
      <DocumentList />
    </div>
  );
    ...
    >
      <div className="font-['Noto_Sans_KR:Regular',sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[#231a16] text-[#3f4e50] text-[0px] text-[14px] w-[min-content] whitespace-pre-wrap">
        <p className="leading-[1.5] mb-0">
          In the case of FAX, you must mail the original application form.
        </p>
        <p className="mb-0">
          <span className="leading-[1.5]">
          ...
          <span className="font-['Noto_Sans_KR:Regular',sans-serif] font-normal leading-[1.5]">
            hana@oneremit.jp
          </span>
          <span className="leading-[1.5]">
            <br aria-hidden="true" />
        ...
        <p className="leading-[1.5] mb-0">
          - Applying for international money transfers is now simpler than ever.
          No need for complicated paperwork—our quick and easy process gets your
          funds sent abroad without any fuss..
          <br aria-hidden="true" />
        ...
        <p className="leading-[1.5] mb-0">
          3. Membership card will be sent within about one week after completing
          the membership application.
        </p>
        <p className="leading-[1.5] mb-0">
          - Get even more flexibility with up to three virtual accounts per
          person. After you finish applying for membership, expect your
          membership card to arrive in about a week. Just remember to keep the
          passwords you set during the application for easy access and
          identification.
          <br aria-hidden="true" />- With this card, you can easily send money
          to any country from your local Lawson stores across Japan, any day of
          the year. International remittances just got simpler.
          <br aria-hidden="true" />
          <br aria-hidden="true" />
        </p>
        <p className="leading-[1.5]">
          4. Please keep passwords registered at the time of member application
          for inquiry and identification
        </p>
      </div>
      <Subsection1 />
      <div
        className="bg-[#3a9944] content-stretch flex gap-[8px] items-center justify-center p-[16px] relative rounded-[10px] shrink-0"
        data-name="Buttons"
      >
        <p className="font-['Noto_Sans_KR:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[16px] text-white">
          Sign up now
...
function Subsection() {
  return (
    <div
      ...
      data-name="Subsection"
    >
      <p className="font-['Noto_Sans_KR:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#231a16] text-[20px] w-full whitespace-pre-wrap">
        Sign up
      </p>
      <TextBlock />
    </div>
...
function TextBlock1() {
  return (
    <div
      className="content-stretch flex flex-col font-['Noto_Sans_KR:Regular',sans-serif] font-normal gap-[48px] items-start relative shrink-0 text-[14px] w-full"
      data-name="Text Block"
    >
      <div className="leading-[0] relative shrink-0 text-[#231a16] w-full">
        <p className="leading-[1.5] mb-0">
          1. You can apply for remittance via internet / mobile.
        </p>
        <p className="leading-[1.5] mb-0">
          2. We welcome visits, FAXes, and emails during our business hours from
          9:00 am to 5:00 pm. Feel free to reach out to us through any of these
        ...
        <ul className="list-disc mb-0">
          <li className="mb-0 ms-[21px]">
            <span className="leading-[1.5]">
              Remittances submitted before 5:00 pm are processed on the same
              day.
            </span>
          </li>
          <li className="mb-0 ms-[21px]">
            <span className="leading-[1.5]">
              Requests received after 5:00 pm will be handled after 10:00 am on
              the next bank day.
            </span>
          </li>
          <li className="ms-[21px]">
            <span className="leading-[1.5]">
              The exchange rate used is the rate at the time of the transfer.
            </span>
          </li>
        </ul>
        ...
        <p className="leading-[1.5]">
          ...
          <br aria-hidden="true" />
          The reference number on the acceptance document is essential for
          questions to us or the receiving bank.
          <br aria-hidden="true" />
          Keep your receipts in order by date for easy access.
        </p>
      </div>
      <p className="leading-[1.5] relative shrink-0 text-[#3a9944] w-full">
        International Wire Transfer Terms of Service
      </p>
    </div>
  );
}
...
function Section1() {
  return (
    <div
      className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full whitespace-pre-wrap"
      data-name="Section"
    >
      <p className="font-['Noto_Sans_KR:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#231a16] text-[20px] w-full">
...
function TextBlock2() {
  return (
    <div
      className="content-stretch flex flex-col font-['Noto_Sans_KR:Regular',sans-serif] font-normal gap-[16px] items-start leading-[1.5] relative shrink-0 text-[#3a9944] text-[14px] w-full"
      data-name="Text Block"
    >
      <p className="relative shrink-0 w-full">
        View and download receipt, transfer results
      </p>
...
function Content() {
  return (
    <div
      className="absolute content-stretch flex flex-col gap-[48px] items-start left-0 p-[64px] top-[81px] w-[1440px]"
      data-name="Content"
    >
...
export default function HowToUse() {
  return (
    <div className="bg-white relative size-full" data-name="How to use">
      ...
      <Content />
      <div
        className="absolute bg-[#f8fafb] content-stretch flex flex-col gap-[48px] items-center left-0 px-[64px] py-[48px] top-[1758px] w-[1440px]"
        data-name="Footer"
      >
        <Container />

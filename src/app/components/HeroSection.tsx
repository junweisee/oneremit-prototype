...
export function HeroSection({ t, sendAmount, setSendAmount, receiveCurrencyCode, setReceiveCurrencyCode }: HeroSectionProps) {
  return (
    <section
      className="relative w-full"
      style={{ background: 'linear-gradient(245deg, rgb(232, 255, 234) 6%, rgb(255, 255, 255) 93%)' }}
    >
          ...
          >
            <h1 className="text-[#231a16] font-bold leading-snug text-[32px] text-left max-lg:text-center">
              ...
              <span
                ...
                style={{ backgroundImage: 'linear-gradient(90deg, #2d8c36 0%, #3a9944 40%, #4aad56 100%)' }}
              >
